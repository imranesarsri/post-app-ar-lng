...
`, X1 = "0%{opacity:0;} 100%{opacity:1;}", q1 = "0%{opacity:1;} 100%{opacity:0;}", _1 = ct("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
function ro(e, t) {
  return lt().captureException(e, X2(t));
}
function $2(e, t) {
...
Event: ${tt(e)}`), !0) : vI(e, t.ignoreErrors) ? (De && H.warn(
  ...
  return function(...t) {
    ...
    return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((i) => {
      i in n && typeof n[i] == "function" && se(n, i, function(o) {
        ...
        return s && (a.mechanism.data.handler = it(s)), Zt(o, a);
      });
    }), e.apply(this, t);
  };
}
...
const b5 = ["top", "right", "bottom", "left"], ot = Math.min, he = Math.max, Yn = Math.round, jn = Math.floor, at = (e) => ({
  x: e,
  y: e
}), v5 = {
  left: "right",
...
const ca = (e) => ({
  ...
  async fn(t) {
    ...
    const w = v / 2 - x / 2, S = N / 2 - I[m] / 2 - 1, L = ot(g[M], S), D = ot(g[y], S), k = L, U = N - I[m] - D, R = N / 2 - I[m] / 2 + w, P = xi(k, R, U), W = Ft(i) != null && R != P && o.reference[m] / 2 - (R < k ? L : D) - I[m] / 2 < 0 ? R < k ? k - R : U - R : 0;
    return {
      [h]: p[h] - W,
      data: {
        [h]: P,
...
function P5(e) {
  ...
  const d = at(0);
  if ((i || !i && r !== "fixed") && ((st(n) !== "body" || dn(o)) && (a = Nr(n)), Oe(n))) {
    const u = Mt(n);
...
function V5(e, t) {
  const n = Mt(e, !0, t === "fixed"), r = n.top + e.clientTop, i = n.left + e.clientLeft, o = Oe(e) ? zt(e) : at(1), a = e.clientWidth * o.x, s = e.clientHeight * o.y, d = i * o.x, u = r * o.y;
  return {
    width: a,
    height: s,
    x: d,
...
function Y5(e, t) {
  ...
  if (n)
    return n;
  let r = Fn(e).filter((s) => Fe(s) && st(s) !== "body"), i = null;
...
function Cc(e, t) {
  ...
  for (; r && U5(r) && Se(r).position === "static"; )
    r = pa(r, t);
  return r && (st(r) === "html" || st(r) === "body" && Se(r).position === "static" && !ho(r)) ? n : r || Z5(e) || n;
}
...
const oM = "bg-[rgba(98,109,121,0.2)] backdrop-blur-[3px]", Io = ({
  ...
  typeof n == "number" ? (qe.width = "100%", qe.maxWidth = n + "px") : n === "full" && (Q = C(
    Q,
    "w-full"
  )), typeof r == "number" ? (qe.height = "100%", qe.maxHeight = r + "px") : r === "full" && (Q = C(
    Q,
    "h-full"
  ));
  let Pe;
  ...
  A(() => {
    ...
    if (s) {
      ...
      if (!s.contains(f)) {
        ...
        s.addEventListener(Qr, u), s.dispatchEvent(y), y.defaultPrevented || (GM(FM(el(s)), { select: !0 }), document.activeElement === f && _e(s));
      }
      return () => {
        s.removeEventListener(Qr, u), setTimeout(() => {
          const y = new CustomEvent(Br, ya);
          s.addEventListener(Br, g), s.dispatchEvent(y), y.defaultPrevented || _e(f ?? document.body, { select: !0 }), s.removeEventListener(Br, g), va.remove(m);
        }, 0);
      };
    }
  }, [s, u, g, m]);
  const I = E(
    (f) => {
      ...
      if (M && y) {
        ...
        v && x ? !f.shiftKey && y === x ? (f.preventDefault(), n && _e(v, { select: !0 })) : f.shiftKey && y === v && (f.preventDefault(), n && _e(x, { select: !0 })) : y === b && f.preventDefault();
      }
    },
    [n, r, m.paused]
  );
...
var xo = "PopperContent", [ty, ny] = rl(xo), cl = O(
  (e, t) => {
    ...
    const Q = (pn = $.arrow) == null ? void 0 : pn.x, ae = (qe = $.arrow) == null ? void 0 : qe.y, ge = ((Pe = $.arrow) == null ? void 0 : Pe.centerOffset) !== 0, [q, Zr] = z();
    return Ut(() => {
...
class Jv {
  ...
  async getThread(t) {
    const n = new URL(`.ghost/activitypub/thread/${btoa(t)}`, this.apiUrl);
    return await this.fetchJSON(n);
  }
}
let Kr;
...
function md({
  ...
  const o = [`activities:${JSON.stringify({ handle: e, includeOwn: t, includeReplies: n, filter: i })}`], a = ut();
...
function _v(e, t) {
  const n = ut(), r = ["search", { handle: e, query: t }];
...
function fd(e, t) {
  const n = ut(), r = ["profiles", { handles: t }];
...
const Rr = ({
  ...
  return A(() => (g.current && g.current.disconnect(), g.current = new IntersectionObserver((h) => {
    ...
    u.length === 0 && !d ? /* @__PURE__ */ c.jsx(nt, { icon: "user-add", children: t }) : /* @__PURE__ */ c.jsx(wi, { children: u.map(({ actor: h, isFollowing: m }) => /* @__PURE__ */ c.jsxs(Ht, { url: h.url, children: [
  ...
  return /* @__PURE__ */ c.jsxs(c.Fragment, { children: [
    ...
    /* @__PURE__ */ c.jsxs("div", { className: "z-0 flex w-full flex-col items-center", children: [
      ...
      a === !1 && s.length === 0 && /* @__PURE__ */ c.jsx("div", { className: "mt-8", children: /* @__PURE__ */ c.jsx(nt, { icon: "bell", children: "When other Fediverse users interact with you, you'll see it here." }) }),
  ...
  const { data: e = 0 } = Bv("index"), { data: t = 0 } = Fv("index"), { data: n = [] } = Xv("index"), { data: r = [] } = qv("index"), { data: i = [] } = Gv("index"), { data: o = [] } = nx("index"), a = o.filter((Z) => Z.type === "Create" && !Z.object.inReplyTo), { data: s } = hd("index"), [d, u] = z("posts"), g = "feed", p = 40, h = 40, m = 40, I = 40, [f, M] = z(p), [y, b] = z(h), [v, x] = z(m), [j, N] = z(I), w = () => {
  ...
  }, U = [
    {
      ...
      contents: /* @__PURE__ */ c.jsxs("div", { className: "ap-posts", children: [
        a.length === 0 ? /* @__PURE__ */ c.jsx(nt, { icon: "pen", children: "You haven't posted anything yet." }) : /* @__PURE__ */ c.jsx("ul", { className: "mx-auto flex max-w-[640px] flex-col", children: a.slice(0, f).map((Z, we) => {
          var Q;
          return /* @__PURE__ */ c.jsxs(
            "li",
            {
    ...
    },
    {
      ...
      contents: /* @__PURE__ */ c.jsxs("div", { className: "ap-likes", children: [
        i.length === 0 ? /* @__PURE__ */ c.jsx(nt, { icon: "heart", children: "You haven't liked anything yet." }) : /* @__PURE__ */ c.jsx("ul", { className: "mx-auto flex max-w-[640px] flex-col", children: i.slice(0, y).map((Z, we) => {
          var Q;
          return /* @__PURE__ */ c.jsxs(
            "li",
            {
    ...
    },
    {
      ...
      contents: /* @__PURE__ */ c.jsxs("div", { children: [
        n.length === 0 ? /* @__PURE__ */ c.jsx(nt, { icon: "user-add", children: "You haven't followed anyone yet." }) : /* @__PURE__ */ c.jsx(wi, { children: n.slice(0, v).map((Z) => /* @__PURE__ */ c.jsxs(
          Ht,
          {
            url: Z.url,
            onClick: () => k(Z),
    ...
    },
    {
      ...
      title: "Followers",
      contents: /* @__PURE__ */ c.jsxs("div", { children: [
        r.length === 0 ? /* @__PURE__ */ c.jsx(nt, { icon: "user-add", children: "Nobody's following you yet. Their loss!" }) : /* @__PURE__ */ c.jsx(wi, { children: r.slice(0, j).map((Z) => /* @__PURE__ */ c.jsxs(
          Ht,
          {
            url: Z.url,
            onClick: () => k(Z),
...
const qa = ({ result: e, update: t }) => {
  ...
  load: async () => import("./modals-dc93ce65.mjs")
...
//# sourceMappingURL=index-696e3897.mjs.map
